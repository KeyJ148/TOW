...
public class GuiElementService {
    ...
    public void addComponentToLocationShiftedToCenter(Component component, Location location) {
        GameObject gameObject = GameObjectFactory.create();
        location.objAdd(gameObject);
        gameObject.setComponent(new GuiElement<>(component));
    }

    public void addComponentToLocationShiftedToCenter(Component component, int x, int y, Location location) {
