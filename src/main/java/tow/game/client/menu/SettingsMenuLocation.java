...
public class SettingsMenuLocation extends MenuLocation {
    ...
    public SettingsMenuLocation() {
        ...
        Button backButton = createButton("Buck to menu", INDENT_X, SETTINGS_PANEL_HEIGHT - BUTTON_HEIGHT - INDENT_X, BUTTON_WIDTH, BUTTON_HEIGHT, event -> { if (event.getAction() == MouseClickEvent.MouseClickAction.RELEASE) new MainMenuLocation();}, mainPanel);
